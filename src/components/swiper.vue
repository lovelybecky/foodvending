<template>
  <div id="slider">
    ...
    <div
      ...
      ref="container"
    >
      <img v-for="img in imgs" :key="img.id" :src="img.url"  alt="img.index">
    </div>
    <!-- index -->
...
<script>
  export default {
    ...
    data () {
      ...
      return{
        imgs:[
          {url: require('../assets/swipertest.jpg'), index: 0},
          {url: require('../assets/swipertest.jpg'), index: 1},
          {url: require('../assets/swipertest.jpg'), index: 2},
          {url: require('../assets/swipertest.jpg'), index: 3}],
        currentIndex: 0,
        buttons: [0,1,2,3],
        timer: null
      }
